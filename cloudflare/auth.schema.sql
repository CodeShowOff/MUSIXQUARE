...
-- Sourced from: auth.nickname-key.migration.sql
...
-- Sourced from: auth.pro-room-generation.migration.sql
...
-- Sourced from: auth.account-stats.migration.sql
...
-- Sourced from: auth.launch-cleanup.migration.sql
...
-- Sourced from: auth.translation-community.migration.sql

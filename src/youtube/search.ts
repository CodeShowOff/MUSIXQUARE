...
// [TEMPORARY HACK] 
// These endpoints are hardcoded to the live 'musixquare.com' production server for local UI testing
// because the local Cloudflare backend worker is currently not being spun up during development.
// TODO: Revert these back to relative paths (e.g., '/api/youtube-search') when you are ready 
// to host and run the backend locally via Wrangler.

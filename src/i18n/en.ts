...
const en = {
  ...
  'account.unavailable': 'Sign-in is temporarily unavailable. You can continue without it.',
  'account.account_title': 'Account',
  'account.stats_sessions_label': 'Sessions joined',
  'account.stats_listening_label': 'Listening time',
  'account.stats_tracks_label': 'Media played',
  'account.stats_count_value': '{{count}}',
  'account.stats_seconds_value': '{{seconds}} sec',
  'account.stats_minutes_value': '{{minutes}} min',
  'account.stats_hours_minutes_value': '{{hours}} hr {{minutes}} min',
  'account.change_nickname': 'Change nickname',
  'account.logout': 'Sign out',
  'account.delete_account': 'Delete account',
  'account.nickname_title': 'Set nickname',
  'account.nickname_message': 'Choose the nickname you will use on MUSIXQUARE.',
  ...
  'account.nickname_whitespace': 'Nicknames cannot contain spaces or invisible characters.',
  ...
  'nav.connect_compact': 'Connect',
  'nav.settings_compact': 'Settings',
  ...
  'player.syncing_compact': 'Syncing…',
  ...
  'player.manual_sync_label': 'Manual sync (ms)',
  ...
  'playlist.empty_hint': 'No media yet.',
  ...
  'player.visualizer_mode_hint': 'Choose how sound is visualized.',
  'settings.ui_sounds_desc': 'Turn notification, join and leave, and touch sounds on or off.',
  'settings.reverb_desc': "Adjust the sound's reverb and resonance.",
  'settings.eq_desc': 'Adjust the tone of the sound. Use it together with the volume control.',
  ...
  'settings.help_translate': 'Help translate',
  ...
  'connect.administrator_list': '{{count}} Administrators',
  ...
  'connect.permission_media_add': 'Manage media',
  'connect.permission_playback_control': 'Playback control',
  'connect.permission_members_kick': 'Kick members',
  'connect.permission_chat_notice': 'Post chat notices',
  'connect.permission_inherited': 'Included',
  'connect.kick_member_message': 'Remove every device connected as {{name}}?',
  'connect.device_toggle': 'Expand/collapse connected devices for {{name}}',
  'connect.device_label': '{{platform}} device ({{code}})',
  'connect.platform_other': 'Other',
  'connect.current_device': 'Current device',
  ...
  'connect.signaling_recovering': 'Reconnecting…',
  'connect.signaling_failed': 'Server connection failed',
  'connect.signaling_recover_action': 'Reconnect',
  ...
  'connect.signaling_restart': 'Restart session',
  'connect.signaling_new_room': 'Start a new room',
  ...
  'setup.enter_host_code': 'Enter invitation code',
  'setup.enter_host_code_alt': 'Scan the QR code or enter the code.',
  'setup.scan_qr': 'Tap to scan',
  ...
  'chat.cmd_slowmode_on': 'Slow mode: {{sec}} seconds between messages',
  ...
  'chat.cmd_d_bot': 'Ask AI to manage the playlist',
  ...
  'chat.cmd_d_nick': 'Change nickname',
  ...
  'toast.added_tracks': '{{count}} tracks added',
  ...
  'share.remote.downloading': 'Downloading remote file...',
  ...
  'dialog.continue_using': 'Continue',
  'dialog.leave_session': 'Leave',
  ...
  'pro.active_tab_message': 'Continuing here will disconnect the existing tab.',
  'pro.use_this_tab': 'Use this tab',
  'pro.upload.batch_progress': 'Uploading tracks {{current}}/{{total}}',
  'pro.upload.batch_failed_title': 'Some tracks couldn’t be uploaded',
